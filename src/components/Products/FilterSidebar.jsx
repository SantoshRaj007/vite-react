...
const FilterSidebar = () => {
    ...
    const brands = ["Urban Threads", "Modern Fit", "Street Style", "Beach Breeze", "Fashionista", "ChicStyle", "LP", "Arrow",];
            ...
            <div className='mb-6'>
                ...
                {genders.map((gender) => (
                    <div key={gender} className='flex items-center mb-1'>
                        ...
                        name='gender' className='mr-2 h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300' />
