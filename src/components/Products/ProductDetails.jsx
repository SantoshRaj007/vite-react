            ...
            <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className='md:w-1/2 md:ml-10'>
                        <h1 className='text-2xl md:text3xl font-semibold mb-2'>{selectedProduct.name}</h1>
                            ...
                            <div className='flex gap-2 mt-2'>
                                {selectedProduct.colors.map((color) =>(
                                    <button 
                                        ...
                                        className={`w-8 h-8 rounded-full border ${selectedColor === color ? "border-4 border-[#ffffff]" : "border-gray-300"}`} style={{backgroundColor: color.toLocaleLowerCase(), filter: "brightness(0.5)",}}></button>
                                ))}
                            </div>
                        </div>
                        <div className='mb-4'>
                        ...
                        <button 
                         ...
                         uppercase ${isButtonDisabled ? "cursor-not-allowed opacity-50" : "hover:bg-rabbit-red"}`}>{isButtonDisabled ? "Adding..." : "Add to cart"}</button>
