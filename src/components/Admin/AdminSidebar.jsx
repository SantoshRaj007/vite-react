    ...
    return (
        <div className='p-6'> 
            ...
            <nav className='flex flex-col space-y-2'>
                ...
                <NavLink to={'/admin/products'} className={({isActive}) => isActive ? "bg-gray-700 text-white py-3 px-4 flex items-center space-x-2" : "text-gray-300 hover:bg-gray-700 hover:text-white py-3 px-4 rounded flex items-center space-x-2"}>
                    <FaBoxOpen/>
                    <span>Products</span>
                </NavLink>
